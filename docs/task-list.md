...
- **Live2D assets never enter the repo:** raw model files stay `.gitignore`d; `scripts/download_models.sh` fetches them; Live2D copyright notice + #LiveroiD credit lines in README (spec §4.4).
